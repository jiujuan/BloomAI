...
function seedTools() {
  ...
  if (Number(count) < 25) {
    const tools = [
      ...
      ['fs_apply_patch', 'fs', 'Apply Patch', 'Preview or atomically apply a unified patch inside an approved workspace.', '{"patch":{"type":"string"},"root":{"type":"string"},"dryRun":{"type":"boolean","default":true},"createBackup":{"type":"boolean","default":true}}', '{"dryRun":{"type":"boolean"},"applied":{"type":"boolean"},"files":{"type":"array"},"conflicts":{"type":"array"}}', 'fs'],
