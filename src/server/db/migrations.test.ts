...
describe('database migrations', () => {
  ...
  it('runs the CLI only against an explicit data directory and is idempotent', () => {
    ...
    expect(migrationVersions()).toHaveLength(49)
  ...
  it('migrates an empty database and records each migration once', async () => {
    ...
    expect(tableNames()).toEqual(
      expect.arrayContaining([
        ...
        'skill_legacy_archives',
        'skill_legacy_migration_runs',
      ])
    )
    expect(migrationVersions()).toEqual([
      ...
      '047-legacy-migration-archive-and-gates',
      '048-mcp-client',
      '049-deduplicate-active-skill-packages',
    ])
