...
export const toolContracts = {
  ...
  bash: {
    ...
    outputSchema: outputObject({ stdout: z.string().optional(), stderr: z.string().optional(), exitCode: z.number().int().optional() }),
  ...
  node_runner: {
    ...
    description: 'Execute JavaScript in a restricted vm context.',
  ...
  python_runner: {
    ...
    description: 'Run Python code in a controlled subprocess.',
    requiresPermission: 'sandbox',
  ...
  shell: {
    ...
    category: 'execution',
    displayName: 'Shell',
    description: 'Run a shell command with explicit permission.',
    requiresPermission: 'shell',
