    ...
    <section className="deep-research-run" aria-live="polite">
      ...
      <div className="deep-research-run-layout">
        <div className="deep-research-main-panel" role="tabpanel">
          ...
          {props.selectedView === 'report' && <ResearchReportView report={props.report} quality={props.run.quality} runStatus={props.run.status} evidenceById={props.evidenceById} snapshotsById={props.snapshotsById} sources={props.sources} artifacts={props.artifacts} onSelectEvidence={props.onSelectEvidence} />}
