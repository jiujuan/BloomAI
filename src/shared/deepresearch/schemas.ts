...
export const researchIterationDecisionInputSummarySchema = z.object({
  ...
  usage: z.object({
    ...
    browserFetches: z.number().int().nonnegative().optional(),
    tokens: z.number(),
...
export const researchBudgetSchema = z.object({
  ...
  maxBrowserFetches: z.number().int().nonnegative().optional(),
  searchConcurrency: z.number(),
  fetchConcurrency: z.number(),
  browserFetchConcurrency: z.number().int().positive().optional(),
